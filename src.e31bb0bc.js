...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"helpers/active-buttons.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.activeBtn = void 0;

var activeBtn = function activeBtn(btn) {
  if (!btn) return;
  btn.disabled = false;
};

exports.activeBtn = activeBtn;
},{}],"helpers/disable-buttons.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.disableBtn = void 0;
...
},{}],"helpers/show-element.js":[function(require,module,exports) {
"use strict";
...
},{}],"elements/generate-variable.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setupTunerVariables = setupTunerVariables;
exports.setupGameVariables = setupGameVariables;
...
},{}],"helpers/hide-element.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.hideElement = void 0;
...
},{}],"library/timer.js":[function(require,module,exports) {
"use strict";
...
var eventEmmiter = {
  ...
  off: function off(eventName, handler) {
    ...
    this._handlers[eventName] = eventHandlers.filter(function (handlerItem) {
...
var timer = _objectSpread(_objectSpread({}, eventEmmiter), {}, {
  timerTime: document.querySelector('.timer__time'),
  _minutes: 0,
  _seconds: 0,
  _timer: null,
  ...
  start: function start(numSeconds) {
    clearTimeout(this._timer);
    this.emit('start');
    this.progress(numSeconds);
  },
  progress: function progress(numSeconds) {
    var _this = this;
    ...
    if (numSeconds > 0) {
      if (this.timerTime) {
        this.timerTime.innerHTML = "".concat(this._minutes, " : ").concat(this._seconds);
      }
      ...
      this._timer = setTimeout(function () {
        return _this.progress(numSeconds);
      }, 1000);
    } else {
...
exports.timer = timer;
},{}],"events/finish-listener.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.finishTuneGame = void 0;

var _activeButtons = require("../helpers/active-buttons");

var _disableButtons = require("../helpers/disable-buttons");

var _showElement = require("../helpers/show-element");

var _generateVariable = require("../elements/generate-variable");

var _hideElement = require("../helpers/hide-element");

var _timer = require("../library/timer");

var _index = require("../index");

var finishTuneGame = function finishTuneGame(stream, canvas, setupP5Variables) {
...
exports.finishTuneGame = finishTuneGame;

var finishTune = function finishTune(stream, canvas, setupP5Variables) {
  setupP5Variables.finishBtnTune.addEventListener('click', function () {
    stopStream(stream);
    removeCanvas(canvas);
    (0, _showElement.showElement)(setupP5Variables.tuneContainerText);
    (0, _activeButtons.activeBtn)(setupP5Variables.startBtnTune);
    (0, _activeButtons.activeBtn)(setupP5Variables.startBtnGame);
    (0, _disableButtons.disableBtn)(setupP5Variables.finishBtnTune);
  }, {
    once: true
  });
};

var finishGame = function finishGame(stream, setupP5Variables) {
  var gameVariables = (0, _generateVariable.setupGameVariables)();

  _timer.timer.on('stop', function () {
    stopStream(stream);
    document.querySelectorAll('.fret.active').forEach(function (fret) {
      fret.classList.remove('active');
    });
    (0, _disableButtons.disableBtn)(setupP5Variables.finishBtnGame);
    (0, _activeButtons.activeBtn)(setupP5Variables.startBtnGame);
    (0, _activeButtons.activeBtn)(setupP5Variables.startBtnTune);
    _index.app.gameVariables.scoreCounter.innerHTML = "".concat(_index.app.score = 0);
    (0, _hideElement.hideElement)([gameVariables.gameInformationContainer, gameVariables.playNoteContainer]);
  });

  setupP5Variables.finishBtnGame.addEventListener('click', function () {
    stopStream(stream);
    document.querySelectorAll('.fret.active').forEach(function (fret) {
      fret.classList.remove('active');
    });
...
var removeCanvas = function removeCanvas(canvas) {
  if (!canvas) return;
  canvas.remove();
};
},{"../helpers/active-buttons":"helpers/active-buttons.js","../helpers/disable-buttons":"helpers/disable-buttons.js","../helpers/show-element":"helpers/show-element.js","../elements/generate-variable":"elements/generate-variable.js","../helpers/hide-element":"helpers/hide-element.js","../library/timer":"library/timer.js","../index":"index.js"}],"../node_modules/@tonaljs/core/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"helpers/check-answer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkRightAnswer = void 0;

var _tonal = require("@tonaljs/tonal");

var _notes = require("../elements/notes");

var _index = require("../index");

var checkRightAnswer = function checkRightAnswer(frequency) {
  if (frequency && frequency > 0) {
    var shownNoteText = _index.app.requiredNote;
    var noteFromFreq = removeOkt(_tonal.Note.fromFreq(frequency));
    var note = findTheClosest(_notes.mapNotes.notesWithPossibleFrequency, frequency);

    _notes.mapNotes.notesWithPossibleFrequency.forEach(function (noteElement) {
      if (noteFromFreq == noteElement.note && note.note == noteFromFreq && noteFromFreq == shownNoteText) {
        document.querySelectorAll('.fret.active').forEach(function (fret) {
          fret.classList.remove('active');
        });

        _index.app.activeNote[_index.app.requiredNote].forEach(function (fret) {
          fret.classList.add('active');
        });

        _index.app.gameVariables.scoreCounter.innerHTML = "".concat(_index.app.score + 1);

        _index.app.showNotes();
      }
    });
  }
};

exports.checkRightAnswer = checkRightAnswer;

var removeOkt = function removeOkt(noteFromFreq) {
  return noteFromFreq.replace(/\d+/g, '');
};

var findTheClosest = function findTheClosest(note, base) {
  var closest = note.map(function (el) {
    return el.frequency.reduce(function (a, b) {
      return Math.abs(b - base) < Math.abs(a - base) ? b : a;
    });
  }).reduce(function (a, b) {
    return Math.abs(b - base) < Math.abs(a - base) ? b : a;
  });
  return note.find(function (note) {
    return note.frequency.includes(closest);
  });
};
},{"@tonaljs/tonal":"../node_modules/@tonaljs/tonal/dist/index.es.js","../elements/notes":"elements/notes.js","../index":"index.js"}],"elements/p5Init.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initPitch = void 0;

var _finishListener = require("../events/finish-listener");

var _timer = require("../library/timer");

var _checkAnswer = require("../helpers/check-answer");

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var initPitch = function initPitch(variableOfPitch, setupP5Variables) {
  if (!setupP5Variables.startBtnTune && !setupP5Variables.finishBtnTune && !setupP5Variables.tuneContainer && !setupP5Variables.tuneContainerText && !setupP5Variables.model_url) {
    return;
  }
  ...
  var p5sketch = function p5sketch(p5library) {
    p5library.setup = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              (0, _finishListener.finishTuneGame)(stream, canvas, setupP5Variables);
    ...
    if (variableOfPitch == 'tuner') {
      p5library.draw = function () {
        ...
        var recordDiff = findCloseNoteForTune();
        var diff = recordDiff;
        drawBorder(diff);
      };
    } else {}
    ...
    function getPitch() {
      pitch.getPitch(function (error, frequency) {
        if (frequency) {
          ...
          if (variableOfPitch !== 'tuner') {
            (0, _checkAnswer.checkRightAnswer)(freq);
          }
        }
    ...
    function findCloseNoteForTune() {
      var closestNote = -1;
      var recordDiff = Infinity;
      setupP5Variables.tuneNotesForZeroString.forEach(function (note) {
        var diff = freq - note.frequency;
    ...
    function drawBorder(diff) {
      var alpha = p5library.map(p5library.abs(diff), 0, 100, 255, 0);
  ...
  var myp5 = new p5(p5sketch, setupP5Variables.tuneContainer);
};

exports.initPitch = initPitch;
},{"../events/finish-listener":"events/finish-listener.js","../library/timer":"library/timer.js","../helpers/check-answer":"helpers/check-answer.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _p5Init = require("/elements/p5Init");

var _activeButtons = require("../src/helpers/active-buttons");

var _hideElement = require("../src/helpers/hide-element");

var _showElement = require("../src/helpers/show-element");

var _generateVariable = require("../src/elements/generate-variable");

var _notes = require("../src/elements/notes");
...
var app = {
  ...
  score: 0,
  setupP5Variables: (0, _generateVariable.setupTunerVariables)(),
  gameVariables: (0, _generateVariable.setupGameVariables)(),
  init: function init() {
    this.createFretboard();
    this.startPlay();
  },
  createFretboard: function createFretboard() {
    for (var stringIndex = 0; stringIndex < this._strings; stringIndex++) {
  ...
  createFrets: function createFrets(stringIndex, string) {
    for (var fret = 0; fret <= this._frets; fret++) {
      var noteFret = document.createElement('div');
      noteFret.classList.add('fret');
      string.appendChild(noteFret);
      var noteName = this.generateNote(fret + this._guitarTuning[stringIndex]);
  ...
  generateNote: function generateNote(noteIndex) {
    noteIndex %= 12;
    var noteName = _notes.mapNotes.noteFlat[noteIndex];
    return noteName;
  },
  startPlay: function startPlay() {
    ...
    if (this.setupP5Variables.startBtnTune && this.setupP5Variables.finishBtnTune) {
      this.setupP5Variables.startBtnTune.addEventListener('click', function () {
        (0, _hideElement.hideElement)(_this.setupP5Variables.tuneContainerText);
        (0, _activeButtons.activeBtn)(_this.setupP5Variables.finishBtnTune);
        (0, _p5Init.initPitch)('tuner', _this.setupP5Variables);
      });
    }

    if (this.setupP5Variables.startBtnGame && this.setupP5Variables.finishBtnGame) {
      this.setupP5Variables.startBtnGame.addEventListener('click', function () {
        (0, _showElement.showElement)([_this.gameVariables.gameInformationContainer, _this.gameVariables.playNoteContainer]);
        (0, _activeButtons.activeBtn)(_this.setupP5Variables.finishBtnGame);

        _this.showNotes();

        (0, _p5Init.initPitch)('game', _this.setupP5Variables);
      });
    }
  },
  showNotes: function showNotes() {
    var note = this.getNote(_notes.mapNotes.noteFlat, [this.requiredNote]);
    this.requiredNote = note;
    this.gameVariables.showNote.innerHTML = note;
  },
  getNote: function getNote(notes, skipNotes) {
    var allowedNotes = notes.filter(function (note) {
      return !skipNotes.includes(note);
    });
    var noteIndex = Math.floor(Math.random() * Math.floor(allowedNotes.length));
    return allowedNotes[noteIndex];
  }
};
exports.app = app;
app.init();
},{"/elements/p5Init":"elements/p5Init.js","../src/helpers/active-buttons":"helpers/active-buttons.js","../src/helpers/hide-element":"helpers/hide-element.js","../src/helpers/show-element":"helpers/show-element.js","../src/elements/generate-variable":"elements/generate-variable.js","../src/elements/notes":"elements/notes.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
